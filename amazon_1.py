...
class product:
    def __init__(self, product_id, product_name, product_price, product_count):
        ...
        # Need to add the product count into the product object, for checking out of stock info
...
style_A_label = Style()
style_A_label.configure('TLabel', font=(
    'calibri', 40, 'bold'), borderwidth='4', padx=500, pady=200)
# -------------------------------------------------------------------------------
...
def update_submit():
    ...
    inventory1.update_product_in_inventory(
        id, name, price, increased_quant, decreased_quant)
    # inventory1.list_all_products_in_inventory()
    insert_into_inventory_disp_box()
...
# labels----------------------------------------
insert_label = tk.Label(root, text='Insert Product',
                        font=('calibre', 10, 'bold'))
update_label = tk.Label(root, text='Update Product',
                        font=('calibre', 10, 'bold'))
# ----------------------------------------------
# insert product--------------------
...
product_id_entry = tk.Entry(
    root, textvariable=product_id_var, font=('calibre', 10, 'normal'))

product_name_label = tk.Label(
    root, text='Product Name', font=('calibre', 10, 'bold'))
product_name_entry = tk.Entry(
    root, textvariable=product_name_var, font=('calibre', 10, 'normal'))

product_price_label = tk.Label(
    root, text='Product Price', font=('calibre', 10, 'bold'))
product_price_entry = tk.Entry(
    root, textvariable=product_price_var, font=('calibre', 10, 'normal'))

# added for the cart management feature(aps)
product_count_label = tk.Label(
    root, text='Product Stock qty.', font=('calibre', 10, 'bold'))
product_count_entry = tk.Entry(
    root, textvariable=product_count_var, font=('calibre', 10, 'normal'))
# ----------------------------------

# update product--------------------
update_product_id_label = tk.Label(
    root, text='Product Id', font=('calibre', 10, 'bold'))
update_product_id_entry = tk.Entry(
    root, textvariable=update_product_id_var, font=('calibre', 10, 'normal'))

update_product_name_label = tk.Label(
    root, text='Update Product Name', font=('calibre', 10, 'bold'))
update_product_name_entry = tk.Entry(
    root, textvariable=update_product_name_var, font=('calibre', 10, 'normal'))

update_product_price_label = tk.Label(
    root, text='UpdateProduct Price', font=('calibre', 10, 'bold'))
update_product_price_entry = tk.Entry(
    root, textvariable=update_product_price_var, font=('calibre', 10, 'normal'))

# added for the cart management feature(aps)
update_increm_count_label = tk.Label(
    root, text='Increase Stock', font=('calibre', 10, 'bold'))
update_increm_count_entry = tk.Entry(
    root, textvariable=update_increm_count_var, font=('calibre', 10, 'normal'))

update_decrem_count_label = tk.Label(
    root, text='Reduce Stock', font=('calibre', 10, 'bold'))
update_decrem_count_entry = tk.Entry(
    root, textvariable=update_decrem_count_var, font=('calibre', 10, 'normal'))
# -------------------------------------
# delete product-----------------------
delete_label = tk.Label(root, text='Delete Product',
                        font=('calibre', 10, 'bold'))
delete_product_id_entry = tk.Entry(
    root, textvariable=delete_product_id_var, font=('calibre', 10, 'normal'))
# -------------------------------------
# delete cart products-----------------
delete_cart_product_label = tk.Label(
    root, text='Delete Cart Product Id:', font=('calibre', 10, 'bold'))
delete_cart_product_entry = tk.Entry(
    root, textvariable=delete_cart_product_id_var, font=('calibre', 10, 'normal'), width=12)
# -------------------------------------
...
# Image labels-------------------------------------
im0_label = tk.Label(
    root, text='Products you might be interested', font=('calibre', 10, 'bold'))
im1_label = tk.Label(root, text='Curry 8  P_ID : 8 ',
                     font=('calibre', 10, 'bold'))
im2_label = tk.Label(root, text='Air Jordan3 P_ID : 3',
                     font=('calibre', 10, 'bold'))
im3_label = tk.Label(root, text='Kobe 7 P_ID : 7',
                     font=('calibre', 10, 'bold'))
im4_label = tk.Label(root, text='Le Bron 18 P_ID : 18',
                     font=('calibre', 10, 'bold'))
# ----------------------------------------------------------
...
inventory_prod_display_label = tk.Label(
    root, text='Products in Inventory', font=('calibre', 15, 'bold'))
